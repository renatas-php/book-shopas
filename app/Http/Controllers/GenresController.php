...
class GenresController extends Controller
{
    ...
    public function store(AuthorGenreCreateRequest $request)
    {
        ...
        return redirect()->route('valdymo-panele')->with('ok', 'Žanras pridėtas');
    }
    ...
    {
        return view('genres.ideti')->with(compact('genre'));
    }
    ...
    public function update(AuthorGenreCreateRequest $request, Genre $genre)
    {
        ...
        return redirect()->route('valdymo-panele')->with('ok', 'Žanras redaguotas');
    }
