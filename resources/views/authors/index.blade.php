...
<div class="container">
	<div class="dashboard-container">
        ...
        <div class="left">
            ...
            <div class="right">
            <a href="{{ route('ideti-autoriu') }}" class="post-book">Pridėti autorių</a>
            </div>
        </div>
		<div class="elements">
		...
		<div class="notes">
			...
			<div class="single-note flex-for-authors">                  
                  <span class="single-note-text">
                    Autoriaus pavadinimas: <strong>{{ $author->name }}</strong>
                     <span class="number">{{ $author->books->count() }} </span>
                  </span>
                  <!-- Buttons -->
                  <div class="single-note-actions">
                   <a href="{{ route('author-edit', $author->id) }}" class="single-note-look-btn">Redagouti </a>
                  </div>                  
			</div>
			@endforeach
			<!-- Single Author End -->
